...
public class ChessMatch implements Serializable, Cloneable {
    ...
    public boolean drawn() {
        ...
        return stalemale() || fiftyMoveRule();
    }
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition,
        ...
        // movement logging
        this.moveDeque.add(new Move(sourcePosition, targetPosition,
                pieceTypeToPromote != null ? pieceTypeToPromote.LETTER : null));
    ...
    public ChessPiece replacePromotedPiece(ChessPiece piece, PieceType type) {
        ChessPiece newPiece;
        switch (type) {
            case BISHOP:
                newPiece = new Bishop(board, this, piece.getColor());
                break;
            case KNIGHT:
                newPiece = new Knight(board, this, piece.getColor());
                break;
            case QUEEN:
                newPiece = new Queen(board, this, piece.getColor());
                break;
            case ROOK:
                newPiece = new Rook(board, this, piece.getColor());
                break;
            default:
